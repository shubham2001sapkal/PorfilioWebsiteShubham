...
<head>
    ...
    <link id='favicon' rel="shortcut icon" href="<?= base_url('assets/images/favicon.jpg') ?>" type="image/x-png">
...
<header>
        ...
        <nav class="navbar">
            ...
            <li><a class="active" href="<?= base_url() ?>#work">Work</a></li>
...
<section class="work" id="work">
  ...
  <div id="filters" class="button-group">
    ...
    <button class="btn" data-filter=".basicweb">Web Project</button>
    <button class="btn" data-filter=".reactjs">React-js Project</button>
  </div>
  ...
  <div class="box-container">
    ...
    <?php if (!empty($projects)): ?>
        <?php foreach ($projects as $project): ?>
            <div class="box tilt <?= esc($project['category']) ?>">
                <img src="<?= base_url('assets/images/projects/' . esc($project['image']) . '.png') ?>" alt="<?= esc($project['name']) ?>" />
                <div class="content">
                    <div class="tag">
  ...
  <div class="backbtn">
    <a href="<?= base_url() ?>#work" class="btn">
